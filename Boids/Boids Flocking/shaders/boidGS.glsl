...
void main()
{
	...
	vec3 Pos = Position - vertexData[0].DeltaSweep*Forward + vertexData[0].HalfWingSpan*Right;
	...
	Pos = Position - vertexData[0].DeltaSweep*Forward - vertexData[0].HalfWingSpan*Right;
